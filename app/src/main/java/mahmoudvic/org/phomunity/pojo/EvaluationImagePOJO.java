...
public class EvaluationImagePOJO {
    private int id;
    ...
    public EvaluationImagePOJO(int id, int imageable_id, String imageable_type, String original_filename, String image_filename,
                               String thumb_filename, String tag, String created_at, String updated_at) {
        this.id = id;
