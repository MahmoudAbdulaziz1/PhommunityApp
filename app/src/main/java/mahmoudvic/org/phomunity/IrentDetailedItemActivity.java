...
public class IrentDetailedItemActivity extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_irent_detailed_item);
        cameraNameTxt = (TextView) findViewById(R.id.irent_detailed_camera_name);
        cameraBrandTxt = (TextView) findViewById(R.id.irent_detailed_camera_brand);
        priceTxt = (TextView) findViewById(R.id.irent_detailed_camera_price);
        branchTxt = (TextView) findViewById(R.id.irent_detailed_camera_branch);
        descTxt = (TextView) findViewById(R.id.irent_detailed_desc);
        ...
        ImageView close = (ImageView) findViewById(R.id.irent_closeId);
        youTubeView = (YouTubePlayerView) findViewById(R.id.irent_youtube_view);
            ...
            youTubeView.initialize(PlayerConfig.YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
                ...
                public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                    if (youTubeInitializationResult.isUserRecoverableError()) {
                        youTubeInitializationResult.getErrorDialog(IrentDetailedItemActivity.this, RECOVERY_REQUEST).show();
                    } else {
                        String error = String.format(getString(R.string.player_error), youTubeInitializationResult.toString());
                        Toast.makeText(IrentDetailedItemActivity.this, error, Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.irent_image_slider);
        LinearLayoutManager layoutManager = new LinearLayoutManager(IrentDetailedItemActivity.this);
        layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
        recyclerView.setLayoutManager(layoutManager);
        IrentImageSlider slider = new IrentImageSlider(IrentDetailedItemActivity.this, img);
        recyclerView.setAdapter(slider);

        call = (Button) findViewById(R.id.irent_call_btn);
        request = (Button) findViewById(R.id.irent_request_btns);
        ...
        request.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle branch2 = getIntent().getBundleExtra("branch");
                finish();
                Intent intent = new Intent(IrentDetailedItemActivity.this, ReservationOrderActivity.class);
    ...
    private void showMessage(String message) {
        Toast.makeText(IrentDetailedItemActivity.this, message, Toast.LENGTH_LONG).show();
    }
