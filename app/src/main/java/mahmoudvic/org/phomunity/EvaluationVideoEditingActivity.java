...
public class EvaluationVideoEditingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evaluation_video_editing);
        ...
        ToolbarUtil.setFragment(EvaluationVideoEditingActivity.this, toolbarLayoutFragment);
        submit = (Button) findViewById(R.id.video_editing_submit);
        noQuestions = (TextView) findViewById(R.id.video_editing_no_question);

        Api.getClient().getPhotographyOuestions("video-editing").enqueue(new Callback<PhotographyPOJO>() {
            @Override
                ...
                if (response != null && response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        if (questionsPOJOS.size() > 0) {
                            ...
                            String category = "video-editing";
                            RecyclerView recyclerView = (RecyclerView) findViewById(R.id.video_editing_recycle);
                            ...
                            EvaluationLightingAdapter adapter = new EvaluationLightingAdapter(EvaluationVideoEditingActivity.this, questions, answer1,
                                    answers2, answers3, answers4, answer1_isCorrect, marks, submit, answers, category,
                                    images, R.drawable.eva_icon, "Video Editing", EvaluationVideoEditingActivity.this);


//                        EvaluationvideographyAdapter adapter = new EvaluationvideographyAdapter(EvaluationVideoEditingActivity.this, questions, answer1,
//                                answers2, answers3, answers4, answer1_isCorrect, marks, submit, answers, category, images);
                        ...
                        Toast.makeText(EvaluationVideoEditingActivity.this, R.string.response_empty, Toast.LENGTH_LONG).show();
                    }
                } else {

                    Toast.makeText(EvaluationVideoEditingActivity.this, R.string.response_failure, Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(Call<PhotographyPOJO> call, Throwable t) {
                Toast.makeText(EvaluationVideoEditingActivity.this, R.string.connection_failure, Toast.LENGTH_LONG).show();
