...
public class EvaluationPhotoEditingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evaluation_photo_editing);
        ...
        ToolbarUtil.setFragment(EvaluationPhotoEditingActivity.this, toolbarLayoutFragment);

        submit = (Button) findViewById(R.id.photo_editing_submit);
        noQuestions = (TextView) findViewById(R.id.photo_editing_no_question);

        Api.getClient().getPhotographyOuestions("photo-editing").enqueue(new Callback<PhotographyPOJO>() {
            @Override
                ...
                if (response != null && response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        if (questionsPOJOS.size() > 0) {
                            ...
                            String category = "photo-editing";
                            RecyclerView recyclerView = (RecyclerView) findViewById(R.id.photo_editing_recycle);
                            ...
                            EvaluationLightingAdapter adapter = new EvaluationLightingAdapter(EvaluationPhotoEditingActivity.this, questions, answer1,
                                    answers2, answers3, answers4, answer1_isCorrect, marks, submit, answers, category, images,
                                    R.drawable.eva_icon, "Photo Editing", EvaluationPhotoEditingActivity.this);


//                        EvaluationvideographyAdapter adapter = new EvaluationvideographyAdapter(EvaluationPhotoEditingActivity.this, questions, answer1,
//                                answers2, answers3, answers4, answer1_isCorrect, marks, submit, answers, category, images);
                        ...
                        Toast.makeText(EvaluationPhotoEditingActivity.this, R.string.response_empty, Toast.LENGTH_LONG).show();
                    }
                } else {

                    Toast.makeText(EvaluationPhotoEditingActivity.this, R.string.response_failure, Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(Call<PhotographyPOJO> call, Throwable t) {
                Toast.makeText(EvaluationPhotoEditingActivity.this, R.string.connection_failure, Toast.LENGTH_LONG).show();
            }
        });
