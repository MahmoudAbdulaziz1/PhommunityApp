...
public class ToolbarMenuCoding {
    ...
    public ToolbarMenuCoding(Context context, Activity activity, final String name) {
        this.context = context;
        this.activity = activity;
        mainLayout = (LinearLayout) activity.findViewById(R.id.menu_response);
