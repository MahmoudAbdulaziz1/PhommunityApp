...
public class EvaluationvideographyActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evaluation_videography);
        ...
        ToolbarUtil.setFragment(EvaluationvideographyActivity.this, toolbarLayoutFragment);

        submit = (Button) findViewById(R.id.videography_submit);
        noQuestions = (TextView) findViewById(R.id.videography_no_question);

        Api.getClient().getPhotographyOuestions("videography").enqueue(new Callback<PhotographyPOJO>() {
            @Override
                ...
                if (response != null && response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        if (questionsPOJOS.size() > 0) {
                            ...
                            RecyclerView recyclerView = (RecyclerView) findViewById(R.id.videography_recycle);
                            ...
                            EvaluationLightingAdapter adapter = new EvaluationLightingAdapter(EvaluationvideographyActivity.this, questions, answer1,
                                    answers2, answers3, answers4, answer1_isCorrect, marks, submit, answers, category,
                                    images, R.drawable.eva_icon, "Videography", EvaluationvideographyActivity.this);


//                        EvaluationvideographyAdapter adapter = new EvaluationvideographyAdapter(EvaluationvideographyActivity.this, questions, answer1,
//                                answers2, answers3, answers4, answer1_isCorrect, marks, submit, answers, category,images);
                        ...
                        Toast.makeText(EvaluationvideographyActivity.this, R.string.response_empty, Toast.LENGTH_LONG).show();
                    }
                } else {

                    Toast.makeText(EvaluationvideographyActivity.this, R.string.response_failure, Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<PhotographyPOJO> call, Throwable t) {
                Toast.makeText(EvaluationvideographyActivity.this, R.string.connection_failure, Toast.LENGTH_LONG).show();
            }
        });
